...
export default function Issues() {
  ...
  // Managers are read-only; only admins can manage issues
  const canManageIssues = user?.role === "admin";
    ...
    <DashboardLayout title="Issues Management">
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          {(canManageIssues || user?.role === "operator") && (
                    ...
                    <TableRow key={issue.id}>
                      ...
                      <TableCell>
                        <span className="capitalize">
                          {(issue.issue_type || issue.type || "other").replace(
                            "_",
                            " "
                          )}
                        </span>
                      ...
                      <TableCell>
                        <div className="flex space-x-2">
                          ...
                          {/* Show resolve/reject buttons only for pending/in_review issues */}
                          {canManageIssues &&
                            (issue.status === "pending" ||
                              ...
                              <>
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    updateIssueStatus(issue.id, "rejected")
                                  }
                                  disabled={statusUpdating === issue.id}
              ...
              <div className="space-y-4">
                ...
                {selectedIssue.record_id && (
                  <div>
                    ...
                    <p className="text-gray-600">
                      Record ID: {selectedIssue.record_id}
                    </p>
                  </div>
                )}
